...
public class SearchActivity extends AppCompatActivity implements SettingDialogFragment.SettingDialogListener{
    ...
    @BindView(R.id.rvArticle) RecyclerView rvArticle;
    ...
    @Override
    public void onFinishSettingDialog(String dateBegin, String sortType, boolean check_art,
                                      boolean check_fashionandstyle, boolean check_sport) {
        Log.d(TAG, "DIALOG:: " +sortType + " || " + dateBegin + " || " + check_art + " || " + check_fashionandstyle + " || " + check_sport);
        Log.d(TAG, "Finish Dialog!!!");
        seachRequest.setSettingSearch(dateBegin, sortType, check_art, check_fashionandstyle, check_sport);
        search();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        final MenuItem settingItem = menu.findItem(R.id.action_setting);
